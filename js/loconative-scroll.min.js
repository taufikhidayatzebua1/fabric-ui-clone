    ...
    u = (function () {
      function e() {
        ...
        t(this, e),
          ...
          (this.isTablet =
            this.isMobile && window.innerWidth >= this.tablet.breakpoint),
                ...
                if (
                  (!h ||
                    ...
                    ("horizontal" === e.direction
                      ? s >= h.left && n < h.right && e.setInView(h, c)
                      : o >= h.top && i < h.bottom && e.setInView(h, c)),
                  h && h.inView)
                )
              ...
              if (!0 !== a(arguments[0])) {
                ...
                i !== e.body
                  ? (p.call(
                      this,
                      i,
                      i.scrollLeft + s.left - o.left,
                      i.scrollTop + s.top - o.top
                    ),
        ...
        function p(i, o, r) {
          ...
          i === e.body
            ? ((a = t),
              ...
              (u = n.scroll))
            : ((a = i), (c = i.scrollLeft), (h = i.scrollTop), (u = l)),
            f({
              scrollable: a,
              method: u,
              startTime: d,
    ...
    O = (function (t) {
      ...
      function o(e) {
        ...
        ((s = t.call(this) || this).onWindowResize = function () {
          ...
          (s.onVirtualScroll = function (t) {
            var e = t.deltaY,
              ...
              o = t.originalEvent;
            o.ctrlKey ||
              ((s.smooth = o.changedTouches ? s.smoothTouch : s.options.smooth),
              s.stopped
                ? o.preventDefault()
                : s.smooth &&
                  4 !== o.buttons &&
                  (s.smooth && o.preventDefault(),
                  (s.targetScroll -=
        ...
        var M =
          ...
          "unknown";
        return (
          (s.virtualScroll = new g({
            el: s.wrapperNode,
            firefoxMultiplier: 50,
            mouseMultiplier: M.includes("Win") ? 1 : 0.4,
            useKeyboard: !1,
          ...
          },
          {
            ...
            value: function (t) {
              var e = this,
                i = t.scroll,
                n = t.velocity;
              i > this.instance.scroll[this.directionAxis]
                      ...
                      if ("horizontal" === t.direction) {
                        ...
                        for (M = 0; M < l.length; M++)
                          "string" == typeof l[M]
                            ? l[M].includes("%")
                              ? (O[M] = parseInt(
                                  (l[M].replace("%", "") * t.windowHeight) / 100
                                ))
                              : (O[M] = parseInt(l[M]))
                            : (O[M] = l[M]);
                        (o += O[0]), (w -= O[1]);
                ...
                Object.entries(this.parallaxElements).forEach(function (r) {
                  ...
                  if ((t && (h = 0), c.inView || i))
                    switch (c.position) {
                      ...
                      default:
                        h =
                          (s[e.directionAxis] - c.middle[e.directionAxis]) *
                          -c.speed;
                    }
                  c.sticky &&
                    (h = c.inView
                      ...
                      : "horizontal" === e.direction
                      ? e.instance.scroll.x < c.left - e.windowWidth &&
                        e.instance.scroll.x < c.left - e.windowWidth / 2
                        ? 0
                        : e.instance.scroll.x > c.right &&
                          e.instance.scroll.x > c.right + 100 &&
                          c.right - c.left + e.windowWidth
                      : e.instance.scroll.y < c.top - e.windowHeight &&
                        e.instance.scroll.y < c.top - e.windowHeight / 2
                      ? 0
                      : e.instance.scroll.y > c.bottom &&
                        e.instance.scroll.y > c.bottom + 100 &&
                        c.bottom - c.top + e.windowHeight),
                    !1 !== h &&
                      ("horizontal" === c.direction ||
                      ("horizontal" === e.direction &&
                        "vertical" !== c.direction)
                        ? e.transform(c.el, h, 0, !t && c.delay)
                        : e.transform(c.el, 0, h, !t && c.delay));
                });
              }
            },
          },
